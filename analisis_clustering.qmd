...
En este documento vamos a realizar un análisis de Clustering de las variables cuantitativas de nuestro dataset. Primero, cargamos las librerías que utilizaremos y el tibble que contenga las variables cuantitativas.
...
```{r}
# No entiendo el warning que sale
```

Lo dividiremos en dos partes, donde realizaremos las dos técnicas aprendidas en clase: el método de *k-means* y el método de clustering jerárquico aglomerativo.
