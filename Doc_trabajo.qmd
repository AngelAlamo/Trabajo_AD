...
`r # 1. se escuchan mas las canciones que salen en verano?`
`r # 2. que caracteristicas son mas comunes en una cancion exitosa`
`r # 3. son igual de famosas las canciones en distintas plataformas`

`r # 4. Que artista tiene mas canciones en listas de spoty`
`r # 5. Top canciones/artistas con mayores reproducciones en las plataformas`
`r # cuantas canciones hay de cada artista`

`r # 6. Top mejores canciones 2023 (o diferenciando por años??)`
`r # 7. correlacion entre listas y reproducciones de spoty`
...
`r #cambiaria el nombre de (streams) a (streams en spoty)`
