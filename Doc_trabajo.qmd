...
A continuación vamos a realizar unos contrastes de correlación para determinar si efectivamente, como hemos visto en el gráfico anterior, estos pares de variables tienen correlaciones positivas o negativas. Empecemos realizando el siguiente contraste donde las variables X e Y son `dance%` y `valence%`  respectivamente:
...
cor.test(spotify2$`energy%`, spotify2$"dance%", alternative="greater")
...
Ahora, veamos qué pasa con estas correlaciones si nos restringimos a las 100 canciones más escuchadas.
